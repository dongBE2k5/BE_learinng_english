...
(async () => {
    try {
        console.log('Finding and removing 100% duplicate words in ETS/TOEIC course words (726 words dataset)...');
        ...
        for (const w of dataWords) {
            // Check non-500 words (the ETS / TOEIC main curriculum words)
        ...
        console.log(`Total 100% duplicate ETS/TOEIC course words removed: ${duplicateCount}`);
